...
sea <- searchTwitter('immigrants OR immigrant OR immigration OR immigrate', n=1000, lang='en', since='2014-05-22', until='2014-05-23')
...
save(allResults, file='22ndMay.RData')
